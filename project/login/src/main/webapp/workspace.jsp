        ...
        <form onsubmit="return false" id="register">
            <div class="modal" id="modal">
                <div class="modal_body">
                    ...
                    <div class="m_body">
                        <div class="modal_label">post_id</div>
                        <input type="text" class="input_box" placeholder="post_id값..." name="post_id" />
                    ...
                    <div class="m_footer">
                        ...
                        <div type="submit" class="modal_btn save" id="save_btn">SAVE</div>
                    </div>
                </div>
            </div>
        </form>
            ...
            <div id="container">
                ...
                <div id="right">
                    <div id="wk_feed" class="feed d-flex">
                        <div class="feed a">상태 <br><button style="background-color: rgb(56, 192, 79); width: 60px; height: 30px; border-radius: 20px; font-size: 12px; border: orange; margin-top: 10px; font-weight: bold; color: white;">진행</button>
                        </div>
                        <div class="feed a">우선 순위 <br>
                            <div style="margin-top: 10px;"><img src="assets/img/긴급.png" style="margin-bottom: 5px;"><span style="color: red; font-size: 15px;">긴급</span>
                            </div>
                        </div>
                        <div class="feed a">진척도 <iframe src="progress.jsp" frameborder="0" style="margin-left: 40px; margin-top : 5px"></iframe> </div>
                        <div class="feed a">시작 날짜 <br>
                            <div style="margin-top: 10px;"></div><span style="font-weight: bold; font-size: 15px;">2023-04-12</span>
                        </div>
                        <div class="feed a">마감 날짜 <br>
                            <div style="margin-top: 10px;"></div><span style="font-weight: bold; font-size: 15px;">2023-04-30</span>
                        </div>
                    </div>
