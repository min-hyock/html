                ...
                <div id="detailModal" class="modal fade">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content" style="height: 600px;">
                            <div class="modal-header">
                                <input class="modal-title" id="event-title"type="text" style="border : 1px solid white; font-size: 1.5em ;"  value="Conference"></input>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        ...
                                        <input id="event-date-start" type="date"value="2023-05-01" style="border : 1px solid white"></input> ~
                                        <input id="event-date-end" type="date"  value="2023-05-01" style="border : 1px solid white"></input>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        <input id="event-location" style="border : 1px solid white" value="장소"></input>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        <textarea id="event-memo" style="border: 1px solid white; width: 400px; height: 300px; outline: none;">메모 apahapsdff knfn; lknslk</textarea>
